    ...
    <Card className={cn("max-w-3xl", className)}>
      <CardHeader className="border-b p-4 sm:p-6">
        <div className="flex flex-col gap-4">
          <div>
            <CardTitle className="text-lg font-semibold tracking-tight lg:text-xl">
      ...
      <CardContent className="p-4 pt-6 sm:p-6 sm:pt-8">{children}</CardContent>
      <CardFooter className="flex justify-between gap-2 border-t p-4 sm:p-6">
        <Button
          variant="outline"
          onClick={onPrevious}
